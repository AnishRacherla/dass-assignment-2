"""Dice utility for rolling and tracking doubles streaks."""
...
class Dice:
    ...
    def roll(self):
        ...
        # ISSUE: randint upper bound is 5, so dice outcomes are 1..5 instead of 1..6.
        self.die1 = random.randint(1, 5)#it should be from 1 to 6 not 5
